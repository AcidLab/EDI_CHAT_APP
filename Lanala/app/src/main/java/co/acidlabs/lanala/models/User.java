...
public class User extends Activity {
    ...
    public User(String id,String code_client, String email,String nom, String type_Personne, String nombreContrat, String nombreSinistre, String nombrePreDeclaration, String nombreContratEnCours, String nombreQuittanceImpaye, String nombreQuittance, String nombrePropositions, String code_agence, String adresse, String identifiant, String ville, String cp_ville, String pays, String premier_responsable, String TEL, String GSM, String FAX, String profession, String secteur_activite, String code_tva, String date_naissance) {
        this.id = id;
    ...
    public static User parseFromResponse(JSONObject object) {
        ...
        String nom = object.optString("Nom");
    ...
    public static User getCurrentUser(Context context) {
        ...
        String nom = sharedPref.getString("nom", null);
    ...
    public static void logoutUser(Context context) {
        ...
        preferences.edit().remove("nom").commit();
